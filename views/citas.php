          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="external-events">
                <div class="external-event bg-green">Atencion</div>
                <div class="external-event bg-yellow">Cita Medica</div>
                <div class="external-event bg-aqua">Ortodoncia</div>
                <div class="external-event bg-light-blue">Ortopedia</div>
                <div class="external-event bg-red">Endodoncia</div>
                <div class="checkbox">
